...
class Option(object):
    def __init__(self, config_path):
        ...
        self.use_mtloss = self.config["use_mtloss"]
    ...
    def _prepare(self):
        ...
        self.save_path = os.path.join(self.save_path, "log_{}_{}-{}_E{}-bs{}-lr{}_{}".format(
            self.dataset, self.net_type, self.img_backbone, self.n_epochs, batch_size, self.lr, self.experiment_id
        ))
