...
class Experiment(object):
    def __init__(self, settings: Option):
        ...
        if self.settings.net_type == "EPMFNet":
            self.model = pc_processor.models.EPMFNet(
                pcd_channels=5,
                img_channels=3,
    ...
    def _loadCheckpoint(self):
        ...
        if self.settings.checkpoint is not None:
            ...
            if self.trainer.aux_optimizer is not None:
        ...
        for epoch in range(self.epoch_start, self.settings.n_epochs):
            ...
            if self.recorder is not None:
                ...
                checkpoint_data = {
                    ...
                    "aux_optimizer": self.trainer.aux_optimizer.state_dict() if self.trainer.aux_optimizer is not None else None,
                    "epoch": epoch,
                }
